...
async function handleDrop(column) {
  ...
  setCurrentPlayer(
    currentPlayer === boardSettings.colors.p2 ? boardSettings.colors.p1 : boardSettings.colors.p2
  );
}
...
<>
      ...
      {!win && (
        ...
        <h2 style={{ color: currentPlayer }}>
          {currentPlayer === boardSettings.colors.p1 ? `${userName}'s move` : "Player 2's move"}
        </h2></div>
      )}
      {win && (
        <>
